...
Node* bstree_successor(Node *x, BSTree tree);
// 找结点(x)的前驱结点。即，查找"二叉树中数据值小于该结点"的"最大结点"。
Node* bstree_predecessor(Node *x, BSTree tree);
 ...
 *     right 是右孩子。
 */
static Node* create_bstree_node(Type key, Node *left, Node* right)
{
    Node* p;
